class XangModFamilyInfo_Mason_Vanguard extends AOCFamilyInfo_Mason_Vanguard;
...
DefaultProperties
{
	...
	NewTertiaryWeapons(1)=(CWeapon=class'XangModWeapon_Buckler_Mason',bEnabledDefault=false)
