...
DefaultProperties
{
	...
	WindupAnimations(2)=(AnimationName=3p_halberd_stabdowntoup,ComboAnimation=,AssociatedSoundCue=,bFullBody=False,bCombo=False,bLoop=False,bForce=false,UniqueShieldSound=none,fModifiedMovement=1.0,fAnimationLength=1.25,fBlendInTime=0.00,fBlendOutTime=0.00,bLastAnimation=false)
