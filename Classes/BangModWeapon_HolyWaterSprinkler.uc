...
*/
class BangModWeapon_HolyWaterSprinkler extends BangModMeleeWeapon;
...
DefaultProperties
{
	...
	AttachmentClass=class'BangModWeaponAttachment_HolyWaterSprinkler'
	...
	ReleaseAnimations(0)=(AnimationName=3p_1hsharp_slash01release,ComboAnimation=3p_1hsharp_slash011release,AssociatedSoundCue=SoundCue'A_Combat_Locomotion.mace_attack_01',bFullBody=true,bCombo=False,bLoop=False,bForce=false,UniqueShieldSound=none,fModifiedMovement=1.0,fAnimationLength=0.45,fBlendInTime=0.00,fBlendOutTime=0.00,bLastAnimation=false)
