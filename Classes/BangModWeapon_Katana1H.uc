...
*
* Weapon: Katana (1H Mode) - Mirrors Longsword1H values, uses DW-WP_SamuraiKatana mesh
*/
class BangModWeapon_Katana1H extends BangModMeleeWeapon;
...
DefaultProperties
{
	...
	AttachmentClass=class'BangModWeaponAttachment_Katana1H'
	...
	AlternativeMode=class'BangModWeapon_Katana'
	...
	ReleaseAnimations(1)=(AnimationName=3p_1hsharp_slash02release,ComboAnimation=3p_1hsharp_slash021release,AlternateAnimation=3p_1hsharp_slash011release,AssociatedSoundCue=SoundCue'A_Combat_Locomotion.Broadsword_Attack_02',bFullBody=true,bCombo=False,bLoop=False,bForce=false,UniqueShieldSound=none,fModifiedMovement=1.0,fAnimationLength=0.5,fBlendInTime=0.0,fBlendOutTime=0.0,bLastAnimation=false)
