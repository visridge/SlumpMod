...
DefaultProperties
{
	 ...
	 */
	ConfigProjectileBaseDamage[0]=(Damage=45,InitialSpeed=5000.0,MaxSpeed=5500.0,AmmoCount=18,InitialGravityScale=0.5,Drag=0.0000035,PitchCorrection=50)
	ConfigProjectileBaseDamage[1]=(Damage=45,InitialSpeed=5000.0,MaxSpeed=5500.0,AmmoCount=18,InitialGravityScale=0.5,Drag=0.0000035,PitchCorrection=0)  // Reduced from 30 to compensate for full movement
	ConfigProjectileBaseDamage[2]=(Damage=45,InitialSpeed=4500.0,MaxSpeed=4500.0,AmmoCount=18,InitialGravityScale=0.6,Drag=0.000004,PitchCorrection=0)
