...
DefaultProperties
{
	...
	NewPrimaryWeapons(9)=(CWeapon=class'BangModWeapon_Puncha',CForceTertiary=(class'BangModWeapon_HuntingKnife', class'BangModWeapon_Kite_Agatha', class'BangModWeapon_TowerShield_Agatha'))
