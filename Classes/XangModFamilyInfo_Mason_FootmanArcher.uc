/**
 * Mason Footman-Archer family info (weapon-keyed STAT override only).
 *
 ...
 * a footman primary (Spear / Brandistock / MasonFlag / GrandLance), the pawn reads
 ...
 */
class XangModFamilyInfo_Mason_FootmanArcher extends XangModFamilyInfo_Mason_Archer
	dependson(AOCPawn);
