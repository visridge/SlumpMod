 ...
 */
class XangModFamilyInfo_Agatha_Assassin extends XangModFamilyInfo_Archer
	dependson(AOCPawn);
...
DefaultProperties
{
	...
	// Man-At-Arms weapon selection (copied from XangModFamilyInfo_Agatha_ManAtArms)
	NewPrimaryWeapons.empty;
	NewPrimaryWeapons(0)=(CWeapon=class'XangModWeapon_Longsword')
