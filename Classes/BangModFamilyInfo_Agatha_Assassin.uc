 ...
 * Agatha Assassin.
 *
 * Fifth class for Agatha. Man-At-Arms stats and weapon selection, but with the
 ...
 */
class BangModFamilyInfo_Agatha_Assassin extends BangModFamilyInfo_Archer
	dependson(AOCPawn);
...
DefaultProperties
{
	...
	// Man-At-Arms weapon selection (copied from BangModFamilyInfo_Agatha_ManAtArms)
	NewPrimaryWeapons.empty;
	NewPrimaryWeapons(0)=(CWeapon=class'BangModWeapon_Longsword')
	...
	NewTertiaryWeapons(3)=(CWeapon=class'BangModWeapon_Heater_Agatha',bEnabledDefault=true)
	bCanDodge=true
