...
DefaultProperties
{
	...
	NewPrimaryWeapons(2)=(CWeapon=class'BangModWeapon_AgathaFlag')
	...
	NewPrimaryWeapons(6)=(CWeapon=class'BangModWeapon_JavelinMelee',CForceTertiary=(class'BangModWeapon_Heater_Agatha'))
	...
	NewPrimaryWeapons(10)=(CWeapon=class'BangModWeapon_HeavyJavelinMelee',CForceTertiary=(class'BangModWeapon_Heater_Agatha'))
	...
	NewTertiaryWeapons(3)=(CWeapon=class'BangModWeapon_Heater_Agatha',bEnabledDefault=false)
