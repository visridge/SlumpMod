...
// ...existing code...
	...
	Helmets.Add((SkeletalMeshPath="CHV_Santa.hat.SK_Chivmas_hat", StaticMeshPath="CHV_Santa.hat.SM_Chivmas_hat", MaterialPath="CHV_Santa.hat.M_chivmas-hat", GearData=(AppID=, GearNameID=ChivmasHat, bVisibleInSelectorIfUnowned=true)))
	Helmets.Add((SkeletalMeshPath="Christmashats.Christmashat", MaterialPath="Christmashats.Christmashat", GearData=(AppID=, GearNameID=ChivmasHat01, bVisibleInSelectorIfUnowned=true)))
	Helmets.Add((SkeletalMeshPath="Christmashats.Christmashat01", MaterialPath="Christmashats.Christmashat01", GearData=(AppID=, GearNameID=ChivmasHat02, bVisibleInSelectorIfUnowned=true)))
	Helmets.Add((SkeletalMeshPath="Christmashats.Christmashat02", MaterialPath="Christmashats.Christmashat02", GearData=(AppID=, GearNameID=ChivmasHat03, bVisibleInSelectorIfUnowned=true)))
	Helmets.Add((SkeletalMeshPath="Christmashats.Christmashat03", MaterialPath="Christmashats.Christmashat03", GearData=(AppID=, GearNameID=ChivmasHat04, bVisibleInSelectorIfUnowned=true)))
	Helmets.Add((SkeletalMeshPath="Christmashats.Christmashat04", MaterialPath="Christmashats.Christmashat04", GearData=(AppID=, GearNameID=ChivmasHat05, bVisibleInSelectorIfUnowned=true)))
	Helmets.Add((SkeletalMeshPath="Christmashats.Christmashat05", MaterialPath="Christmashats.Christmashat05", GearData=(AppID=, GearNameID=ChivmasHat06, bVisibleInSelectorIfUnowned=true)))
	Helmets.Add((SkeletalMeshPath="Christmashats.Christmashat06", MaterialPath="Christmashats.Christmashat06", GearData=(AppID=, GearNameID=ChivmasHat07, bVisibleInSelectorIfUnowned=true)))
	Helmets.Add((SkeletalMeshPath="Christmashats.Christmashat07", MaterialPath="Christmashats.Christmashat07", GearData=(AppID=, GearNameID=ChivmasHat08, bVisibleInSelectorIfUnowned=true)))
	Helmets.Add((SkeletalMeshPath="CHV_Santa.hat.sm_chivmas_antlers", StaticMeshPath="CHV_Santa.hat.sk_chivmas_antlers", GearData=(AppID=, GearNameID=ChivmasAntlers, bVisibleInSelectorIfUnowned=true)))
