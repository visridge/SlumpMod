...
KickOffset=(X=50, Y=0, Z=-65)
	...
	AttackTypeInfo(1)=(fBaseDamage=70.0, fForce=24000, cDamageType="AOC.AOCDmgType_Swing", iWorldHitLenience=6)
	AttackTypeInfo(2)=(fBaseDamage=72.0, fForce=24000, cDamageType="AOC.AOCDmgType_Pierce", iWorldHitLenience=6)
