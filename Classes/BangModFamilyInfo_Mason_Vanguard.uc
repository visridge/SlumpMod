class BangModFamilyInfo_Mason_Vanguard extends AOCFamilyInfo_Mason_Vanguard;
...
DefaultProperties
{
	...
	// NewPrimaryWeapons(10)=(CWeapon=class'BangModWeapon_DoubleBlade',CorrespondingDuelProp=EDUEL_HolyWaterSprinklerUse)
