...
* 
*/
class XangModCharacterInfo_BARB_Mason_Vanguard extends AOCCharacterInfo_Vanguard;
...
defaultproperties
{
	...
	OwnerMeshPath="XangmodCharacters.MasonBarbVanguard1p"
	...
	StandinOwnerMesh=SkeletalMesh'XangmodCharacters.MasonBarbVanguard1p'
