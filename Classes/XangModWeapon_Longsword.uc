...
*/
class XangModWeapon_Longsword extends XangModMeleeWeapon;
...
DefaultProperties
{
	...
	AttachmentClass=class'XangModWeaponAttachment_Longsword'
	...
	AlternativeMode=class'XangModWeapon_Longsword1H'
